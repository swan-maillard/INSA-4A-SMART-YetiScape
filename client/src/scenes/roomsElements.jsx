...
export {getPorte, getTuyaux, getSalle, getTuyau, getTrappe, getImportedMesh, getNavette,getCoffreRouage, getCoffreGemmes, getCodeCoffre, getButtonValdier, getGemme, getTrappeGauche};